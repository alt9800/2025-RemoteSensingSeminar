...
JAMStackのJAMはJavaScript/APIs/Markup から成り立ちます。
...
## ポート転送の補足
最近のトレンドだとVPNも含めたトンネル網として[Tailscale · Best VPN Service for Secure Networks](https://tailscale.com/)の利用が流行っているようです。
